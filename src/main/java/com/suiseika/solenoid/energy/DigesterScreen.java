...
/** Code-drawn Digester GUI (no texture sheet). */
public class DigesterScreen extends AbstractContainerScreen<DigesterMenu> {
    ...
    private static final int BAR_FILL = 0xFFB97AE0;
    private static final int ARROW_X = 70, ARROW_Y = 44, ARROW_W = 24, ARROW_H = 16;
