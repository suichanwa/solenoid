...
/**
 * Fully code-drawn Electromagnetic Separator GUI. No texture sheet: panel, slot recesses, energy bar,
 * progress arrow and the magnetic-field indicator are painted with
 * {@link GuiGraphicsExtractor#fill}. Title and "Inventory" label come from vanilla {@code extractLabels}.
 */
public class SeparatorScreen extends AbstractContainerScreen<SeparatorMenu> {
    ...
    public void extractBackground(GuiGraphicsExtractor g, int mouseX, int mouseY, float a) {
        ...
        // Slot recesses (input + two outputs + player inventory + hotbar, auto-aligned)
        ...
        if (mouseX >= fx && mouseX < fx + FIELD_SIZE && mouseY >= fy && mouseY < fy + FIELD_SIZE) {
