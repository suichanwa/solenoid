...
/**
 * Fully code-drawn Crusher GUI. No texture sheet: the panel, slot recesses, energy bar and progress
 * arrow are all painted with {@link GuiGraphicsExtractor#fill}. The localized title and the
 * "Inventory" label are drawn by {@link AbstractContainerScreen}'s vanilla {@code extractLabels}.
 */
public class CrusherScreen extends AbstractContainerScreen<CrusherMenu> {
    ...
    // Progress arrow. Public so the JEI plugin can hang its recipe click area on the same rectangle.
